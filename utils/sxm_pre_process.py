...
import sys
import sxmReader
from data_preprocess import subtract_2d_plane


class NanonisSXM:
    """Class for handling Nanonis .sxm file.
    """

    def __init__(self, fname, slice_size=(20, 20), output=False, img_pixsize=None):
        self.fname = fname
    ...
    def get_z_raw(self, plot=False, save=''):
        """Extract raw data from z channel.

        Args:
            plot (bool, optional): Switch for whether to plot channel data. Defaults to False.
            save (str, optional): Switch for saving data. Defaults to ''.
        """
    ...
    def z_norm_2d_plane(self, data):
        ...
        new_image = subtract_2d_plane(data)
        return new_image.pixels


if __name__ == '__main__':
    dirt = '../Au_example/2020-select/'
    os.chdir(dirt)
